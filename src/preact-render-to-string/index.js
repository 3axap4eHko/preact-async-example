...
async function asyncRenderToString(vnode, context, opts, inner, isSvgMode) {
	...
	if (typeof nodeName==='function') {
		...
		if (opts.shallow && (inner || opts.renderRootComponent===false)) {
			...
			if (!nodeName.prototype || typeof nodeName.prototype.render!=='function') {
				...
				rendered = await c.render(c.props, c.state, c.context);
	...
	if (html) {
        ...
        isPromised = isPromised || ret instanceof Promise;
...
export default function renderToString(...args) {
	return asyncRenderToString(...args);
}
